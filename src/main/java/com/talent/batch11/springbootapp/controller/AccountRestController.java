...
public class AccountRestController {
    ...
    @PostMapping("/login")
    public ResponseEntity<CommonResponse> loginAccount(@RequestBody LoginInfoApi loginInfoApi) {
    ...
    public ResponseEntity<CommonResponse> register(@RequestBody RegisterInfoApi registerInfo){
    ...
    @PostMapping("/deposit")
    public ResponseEntity deposit(@RequestHeader("Authorization") String authHeader, @RequestBody ServiceRequestApi serviceRequestApi){
        logger.info("[[Reached deposit controller]]");
        return accountService.depositMoneyApi(authHeader, serviceRequestApi);
    }

    @PostMapping("/topup")
    public ResponseEntity topUp(@RequestHeader("Authorization") String authHeader, @RequestBody ServiceRequestApi serviceRequestApi){
        logger.info("[[Reached topup controller]]");
        return accountService.topUpApi(authHeader, serviceRequestApi);
    }

    @PostMapping("/transfer")
    public ResponseEntity transfer(@RequestHeader("Authorization") String authHeader, @RequestBody TransferMoneyInfoApi transferMoneyInfo){
